...
export class ModalHelper {
     ...
     */
    open(comp: any, params?: any, size: 'sm' | 'md' | 'lg' | '' | number = 'lg', options?: any): Observable<any> {
        let cls = '', width = '';
        if (size) {
     ...
     * 静态框，点击蒙层不允许关闭
     */
    static(comp: any, params?: any, size: 'sm' | 'md' | 'lg' | '' | number = 'lg', options?: any): Observable<any> {
