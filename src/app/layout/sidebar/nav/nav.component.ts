...
export class SidebarNavComponent implements OnInit {
    ...
    public floatingEl: HTMLDivElement;
    ...
    public floatingAreaClickHandle(e: MouseEvent) {
    ...
    public genSubNode(linkNode: HTMLLinkElement, item: Menu): HTMLUListElement {
    ...
    public calPos(linkNode: HTMLLinkElement, node: HTMLUListElement) {
