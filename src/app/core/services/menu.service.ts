...
export class MenuService {
    ...
    constructor(public aclService: ACLService, public local: LocalStorageService) { }
    ...
    // addLocal(menus: any): MenuService {
    //     this.local.set(MENUS, menus);
    //     return this;
    // }
     ...
     *      3、否则放在0节点位置
     */
    public loadShortcut(shortcuts: Menu[]) {
    ...
    get menus() {
        // Object.assign(this.data, this.local.get( MENUS));
        // this.resume();
        return this.data;
    }
